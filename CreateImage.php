			...
			for ($x = 0; $x < $this->numberOfRows; $x++) {
				for ($y = 0; $y < $this->numberOfColoms; $y++) {
					...
					if ($colorArray[$index] == 1) {
						...
						imagettftext ($this->my_img, $this->fontSize, 0, $fontXoffset, $fontYoffset, $this->whiteColor,$this->font,$characterArray[$index]);
						...
						imagettftext ($this->my_img, $this->fontSize, 0, $fontXoffset, $fontYoffset,  $this->blackColor,$this->font,$characterArray[$index]);
